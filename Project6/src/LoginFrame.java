...
public class LoginFrame extends JFrame implements KeyListener{
	...
	public static LoginInfoPanel p1 = new LoginInfoPanel();
	...
	private void setbuttons() {
		...
		p1.getitf().addKeyListener(this);
		p1.getptf().addKeyListener(this);
	...
	public void startGame() {
		client  = new Client(this.p1.getitf().getText(), gf.getgamepanel());		
	...
	public class loginListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (db.check(p1.getitf().getText(), String.valueOf(p1.getptf().getPassword())))
				...
				JOptionPane.showMessageDialog(LoginFrame.this, "Confirm your id or password!", "WARNING", JOptionPane.WARNING_MESSAGE);
		}
	}
